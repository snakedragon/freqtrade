...
df = pd.read_feather("./ADA_BTC-5m.feather")
df_ta = add_all_ta_features(df,open="open", high="high", low="low", close="close", volume="volume",fillna=True)
print(df_ta)
...
a = set(df_ta.columns)-set(GodGenes)
print(a)