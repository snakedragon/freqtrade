...
class Bandtastic(IStrategy):
    ...
    buy_fastema = IntParameter(low=3, high=80, default=20, space='buy', optimize=True, load=True)
    buy_slowema = IntParameter(low=5, high=120, default=60, space='buy', optimize=True, load=True)
    ...
    sell_fastema = IntParameter(low=3, high=80, default=7, space='sell', optimize=True, load=True)
    sell_slowema = IntParameter(low=3, high=120, default=6, space='sell', optimize=True, load=True)
    ...
    sell_rsi_enabled = CategoricalParameter([True, False], space='sell', optimize=True, default=True)
